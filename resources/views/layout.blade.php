...
<main class="flex-shrink-0">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
        <div class="container px-5">
            <a class="navbar-brand" href="{{route('home')}}"><span class="fw-bolder text-primary">My Portfolio</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                    ...
                    @if (Route::is('home'))
                        <li class="nav-item"><a class="nav-link" href="{{route('contact.form')}}">Task 3</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{route('file.upload')}}">Task 4</a></li>
                    @endif
                </ul>
            </div>
        </div>
...
<!-- Core theme JS-->
<script scr="{{asset('/')}}assets/js/scripts.js"></script>
</body>
</html>
